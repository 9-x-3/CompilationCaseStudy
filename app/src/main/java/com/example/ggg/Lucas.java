...
public class Lucas extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.activity_lucas, container, false);
    ...
    private void calculateFibonacci() {
        ...
        sequenceString.append("The Lucas sequence of Ln = Ln-1 + Ln-2, with L0 = 2 and L1 = 1 ").append(count).append("\n\n");
